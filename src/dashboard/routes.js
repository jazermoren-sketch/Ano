...
router.get('/servers/:guildId/settings',(req,res)=>res.json({guild:req.dashboardGuild,...getServerDashboard(req.params.guildId),protectionAdvanced:protectionConfig.getSettings(req.params.guildId),whitelist:protectionConfig.getWhitelist(req.params.guildId),embeds:embedService.listEmbeds(req.params.guildId),backups:listBackups(req.params.guildId)}));
